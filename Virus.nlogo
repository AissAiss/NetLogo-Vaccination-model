turtles-own
  [ sick?                ;; if true, the turtle is infectious
    vaccinated-immunity  ;; how many weeks of immunity the turtle has left
...
to get-vaccinated
  set vaccinated-immunity  vaccine-immunity-time
end

;; Guérire une personne
...
to get-older ;; turtle procedure
  ...
  if vaccinated? [ set vaccinated-immunity vaccinated-immunity - 1 ]
...
to recover-or-die ;; turtle procedure
  if sick-time > duration and not vaccinated?                        ;; If the turtle has survived past the virus' duration, then
...
"Vaccinated" 1.0 0 -13791810 true "" "plot count turtles with [ vaccinated? ]"
